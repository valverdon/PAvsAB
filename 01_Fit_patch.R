...
if(Modeltype=="All"|Modeltype=="GLM"){
  if(test){
    Modlist<-Fit_GLM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,test=TRUE)
    Eval_GLM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,NbRunEval=100,Model_list=Modlist,test=TRUE)
...
if(Modeltype=="All"|Modeltype=="GBM"){
  if(test){
    Modlist<-Fit_GBM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,test=TRUE)
    Eval_GBM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,NbRunEval=100,Model_list=Modlist,test=TRUE)
    Eval_GBM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,Model_list=Modlist,test=TRUE, validation.method="random.split-sample")
    Eval_GBM(PAAB=PAAB,arrayID=arrayID,GtoM=GtoM,ENVdata=ENVdata,Model_list=Modlist,test=TRUE, validation.method="random.split-sample",DataSplit="LOO")
