...
BAtaxo2019<-data.frame(Seq=rownames(database)[startthisloop:endthisloop],Kingdom=kingdom,k_conf=kingdom_conf,Phylum=phylum,p_conf=phylum_conf,Class=class,c_conf=class_conf,Order=order,o_conf=order_conf,Family=family,f_conf=family_conf,Genus=genus,g_conf=genus_conf,Species=species,s_conf=species_conf)
# save(FUtaxo2021,file="../../ASV_data/ASV_taxo/FUtaxo2021.Rda")
# nrow(FUtaxo2021)

save(BAtaxo2019,file=paste0("BAtaxo2019",arrayID,".Rda"))
